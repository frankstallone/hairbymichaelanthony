...
///////////////////////////////////////////////////////////////////////////
    ...
    $address = "michaelanthonyhair@me.com";
...
// Please Note, we cannot support this file package if modifications have been made below this line.
	...
	$error = '';
		...
		if(get_magic_quotes_gpc()) { $comments = stripslashes($comments); }
         ...
         $e_subject = 'You\'ve been contacted by ' . $name . ' for a reservation.';

         // Advanced Configuration Option.
		 // You can change this if you feel that you need to.
		 // Developers, you may wish to add more fields to the form, in which case you must be sure to add them here.
					
		 $msg  = "You have been contacted by $name and would like to reserve time on $date, they passed verification and their message is as follows.\r\n\n";
		 $msg .= "$comments\r\n\n";
		 $msg .= "You can contact $name via email, $email or via phone $phone.\r\n\n";
		 $msg .= "-------------------------------------------------------------------------------------------\r\n";
		 $msg .= "This message was sent to you via the an awesome AJAX form by Frank Stallone III | http://iamfrankstallone.com";
		...
		if(mail($address, $e_subject, $msg, "From: $email\r\nReturn-Path: $email\r\n")) {
		 ...
		 echo "<p>Thank you <strong>$name</strong>, your message has been submitted to Michael Anthony. He will get back to you at his earliest convenience.</p>";
		 echo "</div>";
		 echo "</fieldset>";
