		...
		return this.each(function()
		{
			...
			slideWrapper.methods = {
				...
				{	
					...
					if(slideCount <= 1)
						{
							slideWrapper.slider_preloadhelper({delay:200});
						}
						else
						{
							slideWrapper.slider_preloadhelper({callback:slideWrapper.methods.preloadingDone});
...
(function($)
{
	$.fn.slider_preloadhelper = function(variables) 
	{
		var defaults = 
		{
			fadeInSpeed: 800,
